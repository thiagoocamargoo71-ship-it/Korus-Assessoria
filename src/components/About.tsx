    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <div className="h-[1px] w-28 bg-gradient-to-r from-transparent via-[#b38b5f]/40 to-transparent mx-auto mb-10"></div>
          ...
          {/* 🔘 CTA */}
          <button
            className="relative px-7 py-3 rounded-xl text-white font-medium transition transform hover:scale-105 overflow-hidden border border-white/20 mt-8"
            style={{
              background: `
                linear-gradient(
                  120deg,
    ...
    window.open(url, '_blank'); // Abre o WhatsApp em nova aba ou app
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          {[
            ...
            <div
              key={index}
              className="p-8 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 text-center transform hover:scale-105 transition"
            >
              <h3 className="text-3xl md:text-4xl font-bold text-gold">{item.number}</h3>
              <p className="mt-3 text-base md:text-lg text-white/70">{item.label}</p>
            </div>
          ))}
