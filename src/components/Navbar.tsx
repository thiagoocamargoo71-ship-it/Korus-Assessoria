...
>
  {/* 🌐 ÍCONE DE GLOBO: DESTACADO E EM BRONZE */}
  <div className="flex-shrink-0">
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width="36"  // Tamanho aumentado para destaque
      height="36" // Tamanho aumentado para destaque
      viewBox="0 0 24 24" 
      fill="none" 
      stroke="#b38b5f" // Cor Bronze Metálico
      strokeWidth="1.5" 
      strokeLinecap="round" 
  ...
  {/* 📝 TEXTOS DA LOGO: EM BRANCO */}
  <div className="flex flex-col justify-center border-l border-white/10 pl-4 py-1">
    <h1
      className="text-2xl font-serif font-bold leading-none tracking-tight text-white"
      style={{
        textShadow: "0px 1px 8px rgba(0,0,0,0.3)" // Sombra sutil para legibilidade
      }}
    >
      Korus
    </h1>

    <p className="text-[11px] text-white tracking-[0.05em] font-sans mt-1.5 opacity-90">
          ...
          <div className="hidden lg:flex items-center space-x-2">
            {navItems.map((item) => (
              <button
                ...
                className="group relative px-4 py-2 text-sm text-white/80 hover:text-gold transition font-medium tracking-wide"
              >
                {item.label}
